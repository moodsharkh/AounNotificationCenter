...
public class PointsResourceIntTest {
    ...
    private static final String DEFAULT_RADUIS = "AAAAAAAAAA";
    private static final String UPDATED_RADUIS = "BBBBBBBBBB";
    ...
    public void createPoints() throws Exception {
        ...
        assertThat(testPoints.getLon()).isEqualTo(DEFAULT_LON);
        assertThat(testPoints.getLat()).isEqualTo(DEFAULT_LAT);
        assertThat(testPoints.getRaduis()).isEqualTo(DEFAULT_RADUIS);
    }
    ...
    public void getAllPoints() throws Exception {
        ...
        restPointsMockMvc.perform(get("/api/points?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].raduis").value(hasItem(DEFAULT_RADUIS.toString())));
    }
    ...
    public void getPoints() throws Exception {
        ...
        restPointsMockMvc.perform(get("/api/points/{id}", points.getId()))
            ...
            .andExpect(jsonPath("$.raduis").value(DEFAULT_RADUIS.toString()));
    }
    ...
    public void updatePoints() throws Exception {
        ...
        Points testPoints = pointsList.get(pointsList.size() - 1);
        assertThat(testPoints.getLon()).isEqualTo(UPDATED_LON);
        assertThat(testPoints.getLat()).isEqualTo(UPDATED_LAT);
        assertThat(testPoints.getRaduis()).isEqualTo(UPDATED_RADUIS);
    }
